      ...
      <div className="container about-page">
        <div className='text-zone-about'>
          <div className="text-zone">
            ...
            During an recent  6 month coding boot camp, I have furthered my proficiency in a wide range of tools and technologies, including Python, SQL, Pandas, BigQuery, Airflow, Spark, DBT, data modeling, and data management. I am also experienced with Looker Studio allowing me to create compelling and insightful visualizations that bring data to life using interactive dashboards, enabling both layman and company stakeholders to make informed decisions.
